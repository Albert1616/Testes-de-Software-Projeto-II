...
public class CompraServiceTest {
	...
	// BigDecimal custoTotal = service.calcularCustoTotal(carrinho, Regiao.NORDESTE,
	// TipoCliente.OURO);
	...
	// assertEquals(0, custoTotal.compareTo(esperado), "Valor calculado incorreto: "
	// + custoTotal);
	...
	// assertThat(custoTotal).as("Custo Total da
	// Compra").isEqualByComparingTo("0.0");
	// }
}
