...
public class ValoresLimiteTest {
        ...
        // V1, V2, V3, V4, V5, V6, V7, V8, V9 - CT23, CT24, CT25, CT26, CT27, CT28, CT29
        // e CT30
        @ParameterizedTest
        @CsvSource({
                        "2, 0, 20.00", // Q = 2, sem desconto
                        "3, 0, 30.00", // Q = 3, 5% desconto
                        "4, 0, 40.00", // Q = 4, 5% desconto
                        "5, 0, 50.00", // Q = 5, 10% desconto
                        "6, 0, 60.00", // Q = 6, 10% desconto
                        "7, 0, 70.00", // Q = 7, 10% desconto
                        "8, 0, 80.00", // Q = 8, 15% desconto
                        "9, 0, 90.00" // Q = 9, 15% desconto
        })
        ...
        // V10, V11, V12, V13, V14, V15, V16, V17, V18 e V19 - CT31, CT32, CT33, CT34,
        // CT35, CT36, CT37, CT38, CT39 e CT40
        @ParameterizedTest
        @CsvSource({
                        "0, 0, 0.00",
                        "0, 0.01, 0.01",
        ...
        // V21, V22, V23, V24, V25, V26, V27, V28, V29, V30, V31, V32, V33, V34, V35 e
        // V36 - CT41, CT42, CT43, CT44, CT45, CT46, CT47, CT48, CT49, CT50, CT51, CT52,
        // CT53, CT54, CT55, CT56
        @ParameterizedTest
        @CsvSource({
                        "0, 0, 0.00",
